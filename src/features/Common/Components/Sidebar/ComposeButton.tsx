...
const ComposeButton = ({ isShowSidebar }: ComposeButtonProp) => {
  ...
  return (
    <>
      <ButtonRipple
        className={twMerge(
          'group mb-2 ml-3 hidden h-14 w-0 justify-center overflow-hidden border-0 bg-mainColor-500 text-white shadow-none ring-0 hover:bg-blue-700 hover:bg-opacity-90 hover:text-white hover:drop-shadow-md active:bg-slate-300 active:drop-shadow-none lg:flex lg:w-10',
