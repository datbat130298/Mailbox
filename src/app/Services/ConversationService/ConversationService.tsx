...
const dataInbox = [
    ...
    inbox: [
      {
        ...
        type: TypeChat.SENT,
        body: 'Ta chỉ là chiếc lá </br> Việc của mình là xanh</br> Ta chỉ là quả chanh</br> Chờ một người đến vắt</br>Ta chỉ là đôi mắt </br>Ngơ ngác nhìn đời trôi</br>Ta chỉ là bờ môi</br>Muốn chạm vào ai quá!',
  ...
  },
  {
    ...
    author: 'Khoi Tran',
    subject: 'Bibendum fermentum mi. Quisque in placerat lorem.',
    body: 'Bibendum fermentum mi. Quisque in placerat lorem. Cras mattis massa sed mi porta, nec pellentesque risus feugiat. Sed non lectus sodales arcu ultrices feugiat. Etiam nec scelerisque enim. Ut at placerat lorem. Maecenas id orci at dolor vulputate viverra. Sed ultricies dignissim lorem quis sodales. Cras vitae scelerisque ex.',
  },
  {
    id: 13,
    type: TypeChat.INBOX,
...
const getMailById = (id: number) => {
  const data = datawithDay?.find((item) => item.id === id);
  return data;
};
